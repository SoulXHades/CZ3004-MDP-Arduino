...
const double three_grid = 8.755 *3;
const double four_grid = 8.905 *4;
const double five_grid = 9.025 *5;
const double six_grid = 9.005 *6;
const double seven_grid = 8.955 *7;
const double eight_grid = 9.055 *8;
const double nine_grid = 8.985 *9;
...
const double fifteen_grid = 9.365 *15;
